...
def back_chck_ejareh_edari_tejari():
    ...
    otagh_ejareh_edari_tejari_entry.config(state="normal")
...
def add_tree():# برای اضافه کردن درخت به صورت دستی
    ...
    if t and t not in selected_trees:
        ...
        label_result_add.insert(tk.END,t+",")
...
def chck_gheimat_kol_forosh_maskoni(event=None):
    ...
    add_number_toman(event)
    gheimat_kol_forosh_maskoni=gheimat_kol_forosh_maskoni_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_gheimat_pish_ejareh_maskoni(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_pish_ejareh_maskoni=gheimat_pish_ejareh_maskoni_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_gheimat_ejareh_ejareh_maskoni(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_ejareh_ejareh_maskoni=gheimat_ejareh_ejareh_maskoni_entry.get().strip().replace(",", "").replace("تومان", "").strip()
...
def chck_sal_sakht_darkhast_maskoni(event=None):
    sal_sakht_darkhast_maskoni=sal_sakht_darkhast_maskoni_entry.get().strip()

    if sal_sakht_darkhast_maskoni.isdigit() and len(sal_sakht_darkhast_maskoni) ==4:
        sal_sakht_darkhast_maskoni_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_sal_sakht_darkhast_maskoni.config(text="")
        metraj_darkhast_maskoni_entry.config(state="normal")
        tabaghe_darkhast_maskoni_entry.config(state="normal")
        vahed_darkhast_maskoni_entry.config(state="normal")
        ...
        sal_sakht_darkhast_maskoni_entry.config(highlightthickness=2,highlightcolor="red")
        error_lable_sal_sakht_darkhast_maskoni.config(text="فیلد(سال ساخت) باید شامل چهار عدد باشد")
        metraj_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_metraj_darkhast_maskoni(event=None):
    metraj_darkhast_maskoni=metraj_darkhast_maskoni_entry.get().strip()

    if metraj_darkhast_maskoni.isdigit():
        metraj_darkhast_maskoni_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_metraj_darkhast_maskoni.config(text="")
        sal_sakht_darkhast_maskoni_entry.config(state="normal")
        tabaghe_darkhast_maskoni_entry.config(state="normal")
        vahed_darkhast_maskoni_entry.config(state="normal")
        ...
        metraj_darkhast_maskoni_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_metraj_darkhast_maskoni.config(text=" فیلد(متراژ) باید شامل اعداد باشد")
        sal_sakht_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
    
def chck_tabaghe_darkhast_maskoni(event=None):
    tabaghe_darkhast_maskoni=tabaghe_darkhast_maskoni_entry.get().strip()

    if tabaghe_darkhast_maskoni.isdigit():
        tabaghe_darkhast_maskoni_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_tabaghe_darkhast_maskoni.config(text="")
        sal_sakht_darkhast_maskoni_entry.config(state="normal")
        metraj_darkhast_maskoni_entry.config(state="normal")
        vahed_darkhast_maskoni_entry.config(state="normal")
        ...
        tabaghe_darkhast_maskoni_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_tabaghe_darkhast_maskoni.config(text=" فیلد(طبقه) باید شامل اعداد باشد")
        sal_sakht_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_vahed_darkhast_maskoni(event=None):
    vahed_darkhast_maskoni=vahed_darkhast_maskoni_entry.get().strip()

    if vahed_darkhast_maskoni.isdigit():
        vahed_darkhast_maskoni_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_vahed_darkhast_maskoni.config(text="")
        sal_sakht_darkhast_maskoni_entry.config(state="normal")
        metraj_darkhast_maskoni_entry.config(state="normal")
        tabaghe_darkhast_maskoni_entry.config(state="normal")
        ...
        vahed_darkhast_maskoni_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_vahed_darkhast_maskoni.config(text=" فیلد(واحد) باید شامل اعداد باشد")
        sal_sakht_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_otagh_darkhast_maskoni(event=None):
    otagh_darkhast_maskoni=otagh_darkhast_maskoni_entry.get().strip()

    if otagh_darkhast_maskoni.isdigit():
        otagh_darkhast_maskoni_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_otagh_darkhast_maskoni.config(text="")
        sal_sakht_darkhast_maskoni_entry.config(state="normal")
        metraj_darkhast_maskoni_entry.config(state="normal")
        tabaghe_darkhast_maskoni_entry.config(state="normal")
        ...
        otagh_darkhast_maskoni_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_otagh_darkhast_maskoni.config(text=" فیلد(اتاق) باید شامل اعداد باشد")
        sal_sakht_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_gheimat_kol_darkhast_maskoni(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_kol_darkhast_maskoni=gheimat_kol_darkhast_maskoni_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_gheimat_pish_darkhast_maskoni(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_pish_darkhast_maskoni=gheimat_pish_darkhast_maskoni_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_mablagh_ejare_darkhast_maskoni(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_ejare_darkhast_maskoni=mablagh_ejare_darkhast_maskoni_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_name_moshtari_darkhast_maskoni(event=None):
    name_moshtari_darkhast_maskoni = name_moshtari_darkhast_maskoni_entry.get().strip()

    if re.fullmatch(r"[آ-ی\s]+", name_moshtari_darkhast_maskoni):
        name_moshtari_darkhast_maskoni_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_name_moshtari_darkhast_maskoni.config(text="")
        shomareh_moshtari_darkhast_maskoni_entry.config(state="normal")
    else:
        name_moshtari_darkhast_maskoni_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_name_moshtari_darkhast_maskoni.config(text="فیلد (نام مشتری) باید شامل حروف فارسی باشد")
        shomareh_moshtari_darkhast_maskoni_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_sal_sakht_forosh_edari_tejari(event=None):
    sal_sakht_forosh_edari_tejari=sal_sakht_forosh_edari_tejari_entry.get().strip()

    if sal_sakht_forosh_edari_tejari.isdigit() and len(sal_sakht_forosh_edari_tejari) ==4:
        sal_sakht_forosh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_sal_sakht_forosh_edari_tejari.config(text="")
        metraj_forosh_edari_tejari_entry.config(state="normal")
        tabaghe_forosh_edari_tejari_entry.config(state="normal")
        vahed_forosh_edari_tejari_entry.config(state="normal")
        ...
        sal_sakht_forosh_edari_tejari_entry.config(highlightthickness=2,highlightcolor="red")
        error_lable_sal_sakht_forosh_edari_tejari.config(text="فیلد(سال ساخت) باید شامل چهار عدد باشد")
...
def chck_metraj_forosh_edari_tejari(event=None):
    metraj_forosh_edari_tejari=metraj_forosh_edari_tejari_entry.get().strip()

    if metraj_forosh_edari_tejari.isdigit():
        metraj_forosh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_metraj_forosh_edari_tejari.config(text="")
        sal_sakht_forosh_edari_tejari_entry.config(state="normal")
        tabaghe_forosh_edari_tejari_entry.config(state="normal")
        vahed_forosh_edari_tejari_entry.config(state="normal")
        ...
        metraj_forosh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_metraj_forosh_edari_tejari.config(text=" فیلد(متراژ) باید شامل اعداد باشد")
        sal_sakht_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_tabaghe_forosh_edari_tejari(event=None):
    tabaghe_forosh_edari_tejari=tabaghe_forosh_edari_tejari_entry.get().strip()

    if tabaghe_forosh_edari_tejari.isdigit():
        tabaghe_forosh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_tabaghe_forosh_edari_tejari.config(text="")
        sal_sakht_forosh_edari_tejari_entry.config(state="normal")
        metraj_forosh_edari_tejari_entry.config(state="normal")
        vahed_forosh_edari_tejari_entry.config(state="normal")
        ...
        tabaghe_forosh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_tabaghe_forosh_edari_tejari.config(text=" فیلد(طبقه) باید شامل اعداد باشد")
        sal_sakht_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_vahed_forosh_edari_tejari(event=None):
    vahed_forosh_edari_tejari=vahed_forosh_edari_tejari_entry.get().strip()

    if vahed_forosh_edari_tejari.isdigit():
        vahed_forosh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_vahed_forosh_edari_tejari.config(text="")
        sal_sakht_forosh_edari_tejari_entry.config(state="normal")
        metraj_forosh_edari_tejari_entry.config(state="normal")
        tabaghe_forosh_edari_tejari_entry.config(state="normal")
        ...
        vahed_forosh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_vahed_forosh_edari_tejari.config(text=" فیلد(واحد) باید شامل اعداد باشد")
        sal_sakht_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_gheimat_kol_forosh_edari_tejari(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_kol_forosh_edari_tejari=gheimat_kol_forosh_edari_tejari_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_name_malek_forosh_edari_tejari(event=None):
    name_malek_forosh_edari_tejari = name_malek_forosh_edari_tejari_entry.get().strip()

    if re.fullmatch(r"[آ-ی\s]+", name_malek_forosh_edari_tejari):
        name_malek_forosh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_name_malek_forosh_edari_tejari.config(text="")
        shomareh_malek_forosh_edari_tejari_entry.config(state="normal")

    else:
        name_malek_forosh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_name_malek_forosh_edari_tejari.config(text="فیلد (نام مالک) باید شامل حروف فارسی باشد")
        shomareh_malek_forosh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_sal_sakht_ejareh_edari_tejari(event=None):
    sal_sakht_ejareh_edari_tejari=sal_sakht_ejareh_edari_tejari_entry.get().strip()

    if sal_sakht_ejareh_edari_tejari.isdigit() and len(sal_sakht_ejareh_edari_tejari) ==4:
        sal_sakht_ejareh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_sal_sakht_ejareh_edari_tejari.config(text="")
        metraj_melk_ejareh_edari_tejari_entry.config(state="normal")
        tabaghe_ejareh_edari_tejari_entry.config(state="normal")
        vahed_ejareh_edari_tejari_entry.config(state="normal")
        ...
        sal_sakht_ejareh_edari_tejari_entry.config(highlightthickness=2,highlightcolor="red")
        error_lable_sal_sakht_ejareh_edari_tejari.config(text="فیلد(سال ساخت) باید شامل چهار عدد باشد")
...
def chck_metraj_melk_ejareh_edari_tejari(event=None):
    metraj_melk_ejareh_edari_tejari=metraj_melk_ejareh_edari_tejari_entry.get().strip()

    if metraj_melk_ejareh_edari_tejari.isdigit():
        metraj_melk_ejareh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_metraj_melk_ejareh_edari_tejari.config(text="")
        sal_sakht_ejareh_edari_tejari_entry.config(state="normal")
        tabaghe_ejareh_edari_tejari_entry.config(state="normal")
        vahed_ejareh_edari_tejari_entry.config(state="normal")
        ...
        metraj_melk_ejareh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_metraj_melk_ejareh_edari_tejari.config(text=" فیلد(متراژ) باید شامل اعداد باشد")
        sal_sakht_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_tabaghe_ejareh_edari_tejari(event=None):
    tabaghe_ejareh_edari_tejari=tabaghe_ejareh_edari_tejari_entry.get().strip()

    if tabaghe_ejareh_edari_tejari.isdigit():
        tabaghe_ejareh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_tabaghe_ejareh_edari_tejari.config(text="")
        sal_sakht_ejareh_edari_tejari_entry.config(state="normal")
        metraj_melk_ejareh_edari_tejari_entry.config(state="normal")
        vahed_ejareh_edari_tejari_entry.config(state="normal")
        ...
        tabaghe_ejareh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_tabaghe_ejareh_edari_tejari.config(text=" فیلد(طبقه) باید شامل اعداد باشد")
        sal_sakht_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_melk_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        vahed_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")

def chck_vahed_ejareh_edari_tejari(event=None):
    vahed_ejareh_edari_tejari=vahed_ejareh_edari_tejari_entry.get().strip()

    if vahed_ejareh_edari_tejari.isdigit():
        vahed_ejareh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_vahed_ejareh_edari_tejari.config(text="")
        sal_sakht_ejareh_edari_tejari_entry.config(state="normal")
        metraj_melk_ejareh_edari_tejari_entry.config(state="normal")
        tabaghe_ejareh_edari_tejari_entry.config(state="normal")
        ...
        vahed_ejareh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_vahed_ejareh_edari_tejari.config(text=" فیلد(واحد) باید شامل اعداد باشد")
        sal_sakht_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        metraj_melk_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        tabaghe_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
        otagh_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_mablagh_pish_ejareh_edari_tejari(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_pish_ejareh_edari_tejari=mablagh_pish_ejareh_edari_tejari_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_mablagh_ejareh_ejareh_edari_tejari(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_ejare_ejareh_edari_tejari=mablagh_ejare_ejareh_edari_tejari_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_name_malek_ejareh_edari_tejari(event=None):
    name_malek_ejareh_edari_tejari = name_malek_ejareh_edari_tejari_entry.get().strip()

    if re.fullmatch(r"[آ-ی\s]+", name_malek_ejareh_edari_tejari):
        name_malek_ejareh_edari_tejari_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_name_malek_ejareh_edari_tejari.config(text="")
        shomareh_malek_ejareh_edari_tejari_entry.config(state="normal")

    else:
        name_malek_ejareh_edari_tejari_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_name_malek_ejareh_edari_tejari.config(text="فیلد (نام مالک) باید شامل حروف فارسی باشد")
        shomareh_malek_ejareh_edari_tejari_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_gheimat_kol_darkhast_edari_tejari(event=None):
    format_number(event=None)
    add_number_toman(event)
    value = gheimat_kol_darkhast_edari_tejari_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_mablagh_vadie_darkhast_edari_tejari(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_vadie_darkhast_edari_tejari=mablagh_vadie_darkhast_edari_tejari_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_mablagh_ejareh_darkhast_edari_tejari(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_ejareh_darkhast_edari_tejari=mablagh_ejareh_darkhast_edari_tejari_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_name_moshtari_darkhast_edari_tejari(event=None):
    ...
    if re.fullmatch(r"[آ-ی\s]+", name_moshtari_darkhast_edari_tejari):
        ...
        error_lable_name_moshtari_darkhast_edari_tejari.config(text="فیلد (نام مشتری) باید شامل حروف فارسی باشد")
...
def chck_gheimat_metri_forosh_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_metri_forosh_bagh_zamin=gheimat_har_metr_bagh_zamin_forosh_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if gheimat_metri_forosh_bagh_zamin.isdigit():
        ...
        gheimat_kol_forosh_bagh_zamin_entry.config(disabledbackground="#808080",fg="white")
...
def chck_gheimat_kol_forosh_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_kol_forosh_bagh_zamin=gheimat_kol_forosh_bagh_zamin_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if gheimat_kol_forosh_bagh_zamin.isdigit():
        ...
        gheimat_har_metr_bagh_zamin_forosh_entry.config(disabledbackground="#808080",fg="white")
        bagh_loctaion_forosh_bagh_zamin_entry.config(bg="#808080",fg="white")
        bagh_loctaion_forosh_bagh_zamin_entry.config(state="disabled")
...
def chck_metraj_ejareh_bagh_zamin(event=None):
    metraj_zamin_ejareh_bagh_zamin=metraj_zamin_ejareh_bagh_zamin_entry.get().strip()

    if metraj_zamin_ejareh_bagh_zamin.isdigit():
        metraj_zamin_ejareh_bagh_zamin_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_metraj_ejareh_bagh_zamin.config(text="")
       
    else:
        metraj_zamin_ejareh_bagh_zamin_entry.config(highlightcolor="red",highlightthickness=2)
...
def chck_vadieh_ejareh_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    vadieh_ejareh_bagh_zamin=bagh_gheimat_ejareh_bagh_zamin_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if vadieh_ejareh_bagh_zamin.isdigit():
        ...
        bagh_gheimat_ejareh_bagh_zamin_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_vadieh_ejareh_bagh_zamin.config(text=" فیلد(قیمت) باید شامل اعداد باشد")
        bagh_gheimat_har_metr_ejareh_bagh_zamin_entry.config(disabledbackground="#808080",fg="white")
...
def chck_ejareh_mahaneh_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    ejareh_mahaneh_bagh_zamin=bagh_gheimat_har_metr_ejareh_bagh_zamin_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if ejareh_mahaneh_bagh_zamin.isdigit():
        ...
        bagh_gheimat_har_metr_ejareh_bagh_zamin_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_ejareh_mahaneh_bagh_zamin.config(text=" فیلد(قیمت) باید شامل اعداد باشد")
        bagh_gheimat_ejareh_bagh_zamin_entry.config(disabledbackground="#808080",fg="white")
...
def chck_address_ejareh_bagh_zamin(event=None):
    ...
    if (re.fullmatch(r"[آ-ی0-9۰-۹\s]+", address_ejareh_bagh_zamin) and re.search(r"[آ-ی]", address_ejareh_bagh_zamin)):
        ...
        bagh_gheimat_har_metr_ejareh_bagh_zamin_entry.config(state="disabled")
        bagh_gheimat_har_metr_ejareh_bagh_zamin_entry.config(disabledbackground="#808080",disabledforeground="white")

def chck_name_malek_ejareh_bagh_zamin(event=None):
    name_malek_ehareh_bagh_zamin = name_malek_bagh_zamin_entry.get().strip() 

    if re.fullmatch(r"[آ-ی\s]+",name_malek_ehareh_bagh_zamin):
        name_malek_bagh_zamin_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_name_malek_ejareh_bagh_zamin.config(text="")
        number_malek_bagh_zamin_entry.config(state="normal")
    else:
        name_malek_bagh_zamin_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_name_malek_ejareh_bagh_zamin.config(text="فیلد (نام مالک) باید شامل حروف فارسی باشد")
        number_malek_bagh_zamin_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white") 
...
def chck_metraj_darkhast_bagh_zamin(event=None):
    metraj_zamin_darkhast_bagh_zamin=metraj_zamin_darkhast_bagh_zamin_entry.get().strip()

    if metraj_zamin_darkhast_bagh_zamin.isdigit():
        metraj_zamin_darkhast_bagh_zamin_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_metraj_darkhast_bagh_zamin.config(text="")
       
    else:
        metraj_zamin_darkhast_bagh_zamin_entry.config(highlightcolor="red",highlightthickness=2)
...
def chck_gheimat_kol_darkhast_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_kol_darkhast_bagh_zamin=gheimat_kol_bagh_zamin_darkhast_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if gheimat_kol_darkhast_bagh_zamin.isdigit():
        ...
        gheimat_kol_bagh_zamin_darkhast_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_gheimat_kol_darkhast_bagh_zamin.config(text=" فیلد(قیمت) باید شامل اعداد باشد")
        gheimat_har_metr_bagh_zamin_darkhast_entry.config(state="disabled")
        gheimat_har_metr_bagh_zamin_darkhast_entry.config(disabledbackground="#808080",fg="white")
...
def chck_gheimat_metri_darkhast_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_metri_darkhast_bagh_zamin=gheimat_har_metr_bagh_zamin_darkhast_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if gheimat_metri_darkhast_bagh_zamin.isdigit():
        ...
        gheimat_har_metr_bagh_zamin_darkhast_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_gheimat_metri_darkhast_bagh_zamin.config(text=" فیلد(قیمت) باید شامل اعداد باشد")
        gheimat_kol_bagh_zamin_darkhast_entry.config(disabledbackground="#808080",fg="white")
        gheimat_kol_bagh_zamin_darkhast_entry.config(state="disabled")
        bagh_loctaion_darkhast_bagh_zamin_entry.config(bg="#808080",fg="white")
        bagh_loctaion_darkhast_bagh_zamin_entry.config(state="disabled")
...
def chck_vadieh_darkhast_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    vadieh_darkhast_bagh_zamin=gheimat_ejareh_bagh_darkhast_zamin_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if vadieh_darkhast_bagh_zamin.isdigit():
        ...
        gheimat_ejareh_bagh_darkhast_zamin_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_vadieh_darkhast_bagh_zamin.config(text=" فیلد(قیمت) باید شامل اعداد باشد")
        mablagh_ejareh_mahaneh_darkhast_entry.config(disabledbackground="#808080",fg="white")
        mablagh_ejareh_mahaneh_darkhast_entry.config(state="disabled")
        bagh_loctaion_darkhast_bagh_zamin_entry.config(bg="#808080",fg="white")
        bagh_loctaion_darkhast_bagh_zamin_entry.config(state="disabled")
...
def chck_darkhast_ejareh_mahaneh_bagh_zamin(event=None):
    format_number(event=None)
    add_number_toman(event)
    darkhast_ejareh_mahaneh_bagh_zamin=mablagh_ejareh_mahaneh_darkhast_entry.get().replace(",", "").replace("تومان", "").strip()
    ...
    if darkhast_ejareh_mahaneh_bagh_zamin.isdigit():
        ...
        mablagh_ejareh_mahaneh_darkhast_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_darkhast_ejareh_mahaneh_bagh_zamin.config(text=" فیلد(قیمت) باید شامل اعداد باشد")
        gheimat_ejareh_bagh_darkhast_zamin_entry.config(disabledbackground="#808080",fg="white")
        gheimat_ejareh_bagh_darkhast_zamin_entry.config(state="disabled")
        bagh_loctaion_darkhast_bagh_zamin_entry.config(bg="#808080",fg="white")
        bagh_loctaion_darkhast_bagh_zamin_entry.config(state="disabled")
...
def chck_address_darkhast_bagh_zamin(event=None):
    ...
    if (re.fullmatch(r"[آ-ی0-9۰-۹\s]+",bagh_loctaion_darkhast_bagh_zamin) and re.search(r"[آ-ی]",bagh_loctaion_darkhast_bagh_zamin)):
        bagh_loctaion_darkhast_bagh_zamin_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_darkhast_address_bagh_zamin.config(text="")
        gheimat_ejareh_bagh_darkhast_zamin_entry.config(state="normal")
        gheimat_ejareh_bagh_darkhast_zamin_entry.config(bg="#ffffff",fg="black")
        mablagh_ejareh_mahaneh_darkhast_entry.config(state="normal")
        ...
        bagh_loctaion_darkhast_bagh_zamin_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_darkhast_address_bagh_zamin.config(text="فیلد (آدرس) باید شامل حروف فارسی باشد")
        gheimat_kol_bagh_zamin_darkhast_entry.config(disabledbackground="#808080",fg="white")
        gheimat_kol_bagh_zamin_darkhast_entry.config(state="disabled")
        gheimat_har_metr_bagh_zamin_darkhast_entry.config(disabledbackground="#808080",fg="white")
        gheimat_har_metr_bagh_zamin_darkhast_entry.config(state="disabled")
...
def chck_name_moshtari_darkhast_bagh_zamin(event=None):
    name_moshtari_darkhast_bagh_zamin =name_moshtari_darkhast_bagh_entry.get().strip() 
    if re.fullmatch(r"[آ-ی\s]+",name_moshtari_darkhast_bagh_zamin):
        name_moshtari_darkhast_bagh_entry.config(highlightcolor="white",highlightthickness=0)
        error_lable_name_moshtari_darkhast_bagh_zamin.config(text="")
        shomareh_moshtari_darkhast_bagh_entry.config(state="normal")
    else:
        name_moshtari_darkhast_bagh_entry.config(highlightcolor="red",highlightthickness=2)
        error_lable_name_moshtari_darkhast_bagh_zamin.config(text="فیلد (نام مشتری) باید شامل حروف فارسی باشد")
        shomareh_moshtari_darkhast_bagh_entry.config(state="disabled",disabledbackground="#808080",disabledforeground="white")
...
def chck_gheimat_kol_forosh_kargah(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_kol_forosh_kargah=gheimat_kol_forosh_kargah_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_gheimat_pish_ejareh_karghah(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_pish_ejareh_karghah=vadie_ejare_karghah_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_gheimat_ejareh_ejareh_karghah(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_ejareh_ejareh_karghah=gheimat_ejare_ejare_karghah_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_gheimat_kol_darkhast_karghah(event=None):
    format_number(event=None)
    add_number_toman(event)
    gheimat_kol_darkhast_karghah=gheimat_kol_darkhast_kargah_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_mablagh_vadie_darkhast_karghah(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_vadie_darkhast_karghah=mablagh_pish_darkhast_kargah_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_mablagh_ejareh_darkhast_karghah(event=None):
    format_number(event=None)
    add_number_toman(event)
    mablagh_ejareh_darkhast_karghah=ejareh_mahaneh_darkhast_kargah_entry.get().replace(",", "").replace("تومان", "").strip()
...
def chck_name_moshtari_darkhast_karghah(event=None):
    ...
    if re.fullmatch(r"[آ-ی\s]+", name_moshtari_darkhast_karghah):
        ...
        error_lable_name_moshtari_darkhast_karghah.config(text="فیلد (نام مشتری) باید شامل حروف فارسی باشد")
...
#region
def add_number_toman(event):
    entry = event.widget

    value = entry.get().replace(",", "").replace(" تومان", "").strip()

    if value.isdigit():
        entry.delete(0, tk.END)
        entry.insert(0, f"{int(value):,}")

        entry.after(150, add_toman, entry)
...
def add_toman(entry):
    ...
    if value.isdigit():
        entry.delete(0, tk.END)
        entry.insert(0, f"{int(value):,} تومان")
#endregion
#---------------------------------------------------------------------
#-------------------------تابع ثبت فروش------------------------------
#region
    ...
    try:
        if file == "فروش":
            ...
            if melk=="مسکونی":
                ...
                cursor.execute("SHOW TABLES LIKE 'sabt_darkhast_kharid_kargah'")
                if cursor.fetchone():
                    queries.append("""
                    SELECT
                        id,
                        'sabt_darkhast_kharid_kargah',
                        address,
                        gheimat_kol,
                        type_melk,
                        name_moshtari,
                        'درخواست خرید' AS noe_file
                    FROM sabt_darkhast_kharid_kargah
                    WHERE address LIKE %s
                    """)
                    params.append(f"%{address_entry.get().strip()}%")

                cursor.execute("SHOW TABLES LIKE 'sabt_darkhast_ejareh_kargah'")
                if cursor.fetchone():
                    queries.append("""
                    SELECT
                        id,
                        'sabt_darkhast_ejareh_kargah',
                        address,
                        mablagh_pish,
                        type_melk,
                        name_moshtari,
                        'درخواست اجاره' AS noe_file
                    FROM sabt_darkhast_ejareh_kargah
                    WHERE address LIKE %s
                    """)
                    params.append(f"%{address_entry.get().strip()}%")
...
#----------------------------کارگاه---------------------
        ...
        edit_btn_ejareh_kargah.place(x=300, y=30)
        delete_btn_ejareh_kargah.place(x=200, y=30)
        save_button_ejareh_karghah.place_forget()
        ...
        cursor.execute(
            "SELECT * FROM sabt_ejareh_kargah WHERE id=%s",
            (selected_id,)
        )
        ...
        edit_btn_darkhast_kargah.place(x=300, y=30)
        delete_btn_darkhast_kargah.place(x=200, y=30)
        zakhire_darkhast_kargah.place_forget()
        ...
        cursor.execute(
            "SELECT * FROM sabt_darkhast_kharid_kargah WHERE id=%s",
            (selected_id,)
        )
        ...
        cursor.execute(
            "SELECT * FROM sabt_darkhast_ejareh_kargah WHERE id=%s",
            (selected_id,)
        )
...
#-----------------باغ و زمین-------------------
        ...
        zakhire_ejareh_bagh_zamin.place_forget()
        edit_btn_ejareh_bagh_zamin.place(x=300, y=30)
        delete_btn_ejareh_bagh_zamin.place(x=200, y=30)
        ...
        cursor.execute(
            "SELECT * FROM ejareh_bagh WHERE id=%s",
            (selected_id,)
        )
        ...
        bagh_type_combo.set("باغ")
        change_bagh_zamin1(None)

        metraj_zamin_ejareh_bagh_zamin_entry.delete(0, tk.END)
        metraj_zamin_ejareh_bagh_zamin_entry.insert(0, data[2])
        ...
        name_malek_bagh_zamin_entry.delete(0, tk.END)
        name_malek_bagh_zamin_entry.insert(0, data[8])

        number_malek_bagh_zamin_entry.delete(0, tk.END)
        number_malek_bagh_zamin_entry.insert(0, data[9])

        metraj_tree_entry.delete(0, tk.END)
        metraj_tree_entry.insert(0, data[10])

        tree_count_entry.delete(0, tk.END)
        tree_count_entry.insert(0, data[11])

        abyari_combo.set(data[13])

        chah_bagh_ejareh_var.set(int(data[14]))
        estakhr_bagh_var.set(int(data[15]))
        divar_ejareh_bagh_var.set(int(data[16]))
        bargh_bagh_var.set(int(data[17]))

        var0.set(int(data[18]))
        home_true_false1()

        metraj_vila_bagh_entry.delete(0, tk.END)
        metraj_vila_bagh_entry.insert(0, data[19])

        sal_sakht_vila_bagh_entry.delete(0, tk.END)
        sal_sakht_vila_bagh_entry.insert(0, data[20])

        type_vila_ejareh_bagh_zamin_combo.set(data[21])

        toilet_bagh_combo.set(data[23])
        hamam_bagh_combo.set(data[24])

        mojavez_sakht_ejareh_bagh_var.set(int(data[25]))
        sanad_bagh_combo.set(data[26])
        mohavate_ejareh_bagh_var.set(int(data[27]))
        gaz_bagh_var.set(int(data[28]))
        ...
        if data[12]:
            selected_trees.extend(
                [x.strip() for x in data[12].split(",") if x.strip()]
            )

            label_result_add.insert(
                "1.0",
                ",".join(selected_trees) + ","
            )
        ...
        if data[22]:
            selected_option.extend(
                [x.strip() for x in data[22].split(",") if x.strip()]
            )

        label_result2_add.config(
            text=",".join(selected_option)
        )
        ...
        cursor.execute(
            "SELECT * FROM ejareh_zamin WHERE id=%s",
            (selected_id,)
        )
        ...
        # نمایش فرم زمین
        bagh_type_combo.set("زمین کشاورزی")
        change_bagh_zamin1(None)
        ...
        karbari_ejareh_ejareh_bagh_zamin_combo.set(data[10])
        khak_ejareh_ejareh_bagh_zamin_combo.set(data[11])
        ab_ejareh_ejareh_bagh_zamin_combo.set(data[12])

        security_zamin_ejareh_var.set(int(data[13]))
        bargh_tak_ejareh_zamin_var.set(int(data[14]))
        bargh_se_faz_ejareh_zamin_var.set(int(data[15]))
        anbar_ejareh_zamin_var.set(int(data[16]))
        fans_ejareh_zamin_var.set(int(data[17]))
        mojavaz_chah_ejareh_zamin_var.set(int(data[18]))
...
def update_darkhast_kargah():
    ...
    if combo_darkhast_kargah.get() == "درخواست خرید کارگاه":
...
def delete_ejareh_kargah():
    ...
    cursor.execute(
        "DELETE FROM sabt_ejareh_kargah WHERE id=%s",
        (selected_id,)
    )
...
def delete_darkhast_kargah():
    ...
    if combo_darkhast_kargah.get() == "درخواست خرید کارگاه":
        cursor.execute(
            "DELETE FROM sabt_darkhast_kharid_kargah WHERE id=%s",
            (selected_id,)
        )

    else:
        cursor.execute(
            "DELETE FROM sabt_darkhast_ejareh_kargah WHERE id=%s",
            (selected_id,)
        )
...
def delete_ejareh_bagh_zamin():
    ...
    if bagh_type_combo.get() == "باغ":
        ...
        cursor.execute(
            "DELETE FROM ejareh_bagh WHERE id=%s",
            (selected_id,)
        )
        ...
        cursor.execute(
            "DELETE FROM ejareh_zamin WHERE id=%s",
            (selected_id,)
        )
...
def refresh_after_edit():
    ...
    save_button_ejareh_karghah.place(x=300,y=30)
    edit_btn_ejareh_kargah.place_forget()
    delete_btn_ejareh_kargah.place_forget()
...
def format_number(event):
    ...
    price_entries = [
        ...
        gheimat_kol_forosh_bagh_zamin_entry,
        gheimat_har_metr_bagh_zamin_forosh_entry,
        gheimat_kol_forosh_kargah_entry,
        gheimat_pish_ejareh_maskoni_entry,
        gheimat_ejareh_ejareh_maskoni_entry,
        mablagh_pish_ejareh_edari_tejari_entry,
        mablagh_ejare_ejareh_edari_tejari_entry,
        bagh_gheimat_ejareh_bagh_zamin_entry,
        bagh_gheimat_har_metr_ejareh_bagh_zamin_entry,
        vadie_ejare_karghah_entry,
        gheimat_ejare_ejare_karghah_entry,
        gheimat_kol_darkhast_maskoni_entry,
        gheimat_pish_darkhast_maskoni_entry,
        mablagh_ejare_darkhast_maskoni_entry,
        gheimat_kol_darkhast_edari_tejari_entry,
        mablagh_ejareh_darkhast_edari_tejari_entry,
        mablagh_vadie_darkhast_edari_tejari_entry,
        gheimat_kol_bagh_zamin_darkhast_entry,
        gheimat_har_metr_bagh_zamin_darkhast_entry,
        gheimat_ejareh_bagh_darkhast_zamin_entry,
        mablagh_ejareh_mahaneh_darkhast_entry,
        ejareh_mahaneh_darkhast_kargah_entry,
        gheimat_kol_darkhast_kargah_entry,
        mablagh_pish_darkhast_kargah_entry
]
...
label_down_ejareh_maskoni=tk.Label(ejareh_maskoni_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
gheimat_pish_ejareh_maskoni_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_ejareh_ejareh_maskoni_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
label_down_ejareh_edari_tejari=tk.Label(ejareh_edari_tejari_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
sal_sakht_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_sal_sakht_ejareh_edari_tejari)
...
metraj_melk_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_metraj_melk_ejareh_edari_tejari)
...
tabaghe_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_tabaghe_ejareh_edari_tejari)
...
vahed_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_vahed_ejareh_edari_tejari)

otagh_ejareh_edari_tejari= tk.Label(frame_up_right_ejareh_edari_tejari, text="اتاق", bg="#052340", fg="#ffffff", font=("Shabnam", 12), width=9)
otagh_ejareh_edari_tejari.place(x=465, y=240, anchor="e")

otagh_ejareh_edari_tejari_entry=tk.Entry(frame_up_right_ejareh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
otagh_ejareh_edari_tejari_entry.place(x=18, y=230, width=350, height=25)
otagh_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_otagh_ejareh_edari_tejari)
...
mablagh_pish_ejareh_edari_tejari_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
mablagh_ejare_ejareh_edari_tejari_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
name_malek_ejareh_edari_tejari=tk.Label(frame_midde_left_ejareh_edari_tejari, text="نام مالک", bg="#052340", fg="#ffffff", font=("Shabnam", 12), width=9)
name_malek_ejareh_edari_tejari.place(x=600, y=30,anchor="e")
...
name_malek_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_name_malek_ejareh_edari_tejari)

shomareh_malek_ejareh_edari_tejari= tk.Label(frame_midde_left_ejareh_edari_tejari, text="شماره مالک", bg="#052340", fg="#ffffff", font=("Shabnam", 12), width=9)
shomareh_malek_ejareh_edari_tejari.place(x=600, y=80,anchor="e")
...
shomareh_malek_ejareh_edari_tejari_entry.bind("<KeyRelease>",chck_shomareh_malek_ejareh_edari_tejari)
...
#------------------------------------ارور لیبل های اجاره اداری/ تجاری--------------------
error_lable_sal_sakht_ejareh_edari_tejari= tk.Label(ejareh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_sal_sakht_ejareh_edari_tejari.place(x=900 , y=20)

error_lable_metraj_melk_ejareh_edari_tejari= tk.Label(ejareh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_metraj_melk_ejareh_edari_tejari.place(x=900 , y=20)

error_lable_tabaghe_ejareh_edari_tejari= tk.Label(ejareh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_tabaghe_ejareh_edari_tejari.place(x=900 , y=20)
...
label_down_ejareh_bagh_zamin=tk.Label(ejareh_bagh_zamin_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
metraj_zamin_ejareh_bagh_zamin_entry.bind("<KeyRelease>",chck_metraj_ejareh_bagh_zamin)
...
bagh_gheimat_ejareh_bagh_zamin_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
bagh_gheimat_har_metr_ejareh_bagh_zamin_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
name_malek_bagh_zamin_entry.bind("<KeyRelease>",chck_name_malek_ejareh_bagh_zamin)
...
number_malek_bagh_zamin_entry.bind("<KeyRelease>",chck_shomareh_malek_ejareh_bagh_zamin)
#-----------------------------------فریم پایین------------------------------------------
...
back_to_home_ejareh_bagh_zamin.place(x=400,y=30)
...
delete_btn_ejareh_bagh_zamin=tk.Button(ejareh_bagh_zamin_window,text="❌حذف",command=delete_ejareh_bagh_zamin,bg="#8B0000",fg="#ffffff",height=1,width=10 )
delete_btn_ejareh_bagh_zamin.place_forget()

edit_btn_ejareh_bagh_zamin=tk.Button(ejareh_bagh_zamin_window,text="📝ثبت ویرایش",command=update_ejareh_bagh_zamin,bg="#00BFFF", fg="#ffffff",width=10,height=1,)
edit_btn_ejareh_bagh_zamin.place_forget()
#---------------------------------ارور لیبل ها----------------------
error_lable_metraj_ejareh_bagh_zamin=tk.Label(ejareh_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_metraj_ejareh_bagh_zamin.place(x=900,y=20)

error_lable_vadieh_ejareh_bagh_zamin=tk.Label(ejareh_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_vadieh_ejareh_bagh_zamin.place(x=900,y=20)
...
label_down_ejareh_karghah=tk.Label(ejareh_karghah_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
vadie_ejare_karghah_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_ejare_ejare_karghah_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
back_to_home_ejareh_karghah.place(x=400,y=30)

save_button_ejareh_karghah=tk.Button(ejareh_karghah_window,text="💾ذخیره",bg="#00BFFF", fg="#ffffff",width=10,height=1,command=sabt_ejareh_kargah)
save_button_ejareh_karghah.place(x=300,y=30)

delete_btn_ejareh_kargah=tk.Button(ejareh_karghah_window,text="❌حذف",command=delete_ejareh_kargah,bg="#8B0000",fg="#ffffff",height=1,width=10 )
delete_btn_ejareh_kargah.place_forget()
...
label_down_forosh_maskoni=tk.Label(forosh_maskoni_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
gheimat_kol_forosh_maskoni=tk.Label(frame_midde_right_forosh_maskoni, text=" قیمت کل ", bg="#052340", fg="#ffffff", font=("Shabnam", 12), width=9,textvariable=var)
...
gheimat_kol_forosh_maskoni_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
label_down_forosh_edari_tejari=tk.Label(forosh_edari_tejari_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
sal_sakht_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_sal_sakht_forosh_edari_tejari)
...
metraj_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_metraj_forosh_edari_tejari)
...
tabaghe_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_tabaghe_forosh_edari_tejari)
...
vahed_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_vahed_forosh_edari_tejari)
...
otagh_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_otagh_forosh_edari_tejari)
...
gheimat_kol_forosh_edari_tejari_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
name_malek_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_name_malek_forosh_edari_tejari)
...
shomareh_malek_forosh_edari_tejari_entry.bind("<KeyRelease>",chck_shomareh_malek_forosh_edari_tejari)
...
#------------------------------------ارور لیبل های فروش اداری/ تجاری--------------------
error_lable_sal_sakht_forosh_edari_tejari= tk.Label(forosh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_sal_sakht_forosh_edari_tejari.place(x=900 , y=20)

error_lable_metraj_forosh_edari_tejari= tk.Label(forosh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_metraj_forosh_edari_tejari.place(x=900 , y=20)

error_lable_tabaghe_forosh_edari_tejari= tk.Label(forosh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_tabaghe_forosh_edari_tejari.place(x=900 , y=20)

error_lable_vahed_forosh_edari_tejari= tk.Label(forosh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_vahed_forosh_edari_tejari.place(x=900 , y=20)

error_lable_otagh_forosh_edari_tejari= tk.Label(forosh_edari_tejari_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_otagh_forosh_edari_tejari.place(x=900 , y=20)
...
label_down_forosh_bagh_zamin=tk.Label(forosh_bagh_zamin_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
gheimat_har_metr_bagh_zamin_forosh_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_kol_forosh_bagh_zamin_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
label_down_forosh_karghah=tk.Label(forosh_karghah_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
gheimat_kol_forosh_kargah_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
label_midde_left_darkhast_maskoni=tk.Label(darkhast_maskoni_window,text="👤اطلاعات مشتری",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_midde_left_darkhast_maskoni.place(x=100,y=395)

label_down_darkhast_maskoni=tk.Label(darkhast_maskoni_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
sal_sakht_darkhast_maskoni_entry.bind("<KeyRelease>",chck_sal_sakht_darkhast_maskoni)

metraj_darkhast_maskoni=tk.Label(frame_up_right_darkhast_maskoni,text="متراژ",bg="#052340",fg="#ffffff",font=("Shabnam",12),width=9)
metraj_darkhast_maskoni.place(x=465, y=120, anchor="e")
...
metraj_darkhast_maskoni_entry.bind("<KeyRelease>",chck_metraj_darkhast_maskoni)
...
tabaghe_darkhast_maskoni_entry.bind("<KeyRelease>",chck_tabaghe_darkhast_maskoni)
...
vahed_darkhast_maskoni_entry.bind("<KeyRelease>",chck_vahed_darkhast_maskoni)
...
otagh_darkhast_maskoni_entry.bind("<KeyRelease>",chck_otagh_darkhast_maskoni)
#-------------------------------فریم بالا سمت چپ-------------------------------------------
...
gheimat_kol_darkhast_maskoni_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_pish_darkhast_maskoni_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
mablagh_ejare_darkhast_maskoni_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
name_moshtari_darkhast_maskoni_entry.bind("<KeyRelease>",chck_name_moshtari_darkhast_maskoni)
...
shomareh_moshtari_darkhast_maskoni_entry.bind("<KeyRelease>",chck_shomareh_moshtari_darkhast_maskoni)
...
label_midde_left_darkhast_edari_tejari=tk.Label(darkhast_edari_tejari_window,text="👤اطلاعات مشتری",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_midde_left_darkhast_edari_tejari.place(x=100,y=395)

label_down_darkhast_edari_tejari=tk.Label(darkhast_edari_tejari_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
gheimat_kol_darkhast_edari_tejari_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
mablagh_ejareh_darkhast_edari_tejari_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
mablagh_vadie_darkhast_edari_tejari_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
label_midde_left_darkhast_bagh_zamin=tk.Label(darkhast_bagh_zamin_window,text="👤اطلاعات مشتری",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_midde_left_darkhast_bagh_zamin.place(x=100,y=375)

label_down_darkhast_bagh_zamin=tk.Label(darkhast_bagh_zamin_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
metraj_zamin_darkhast_bagh_zamin_entry.bind("<KeyRelease>",chck_metraj_darkhast_bagh_zamin)
...
gheimat_kol_bagh_zamin_darkhast_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_har_metr_bagh_zamin_darkhast_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_ejareh_bagh_darkhast_zamin_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
mablagh_ejareh_mahaneh_darkhast_entry.bind("<KeyRelease>",add_number_toman,add="+")
mablagh_ejareh_mahaneh_darkhast_entry.place_forget()
...
name_moshtari_darkhast_bagh_entry.bind("<KeyRelease>",chck_name_moshtari_darkhast_bagh_zamin)
...
shomareh_moshtari_darkhast_bagh_entry.bind("<KeyRelease>",chck_shomareh_moshtari_darkhast_bagh_zamin)
#--------------------------فریم پایین-----------------------------
...
#---------------------------------------ارور لیبل های ذرخواست باغ زمبن---------------
error_lable_metraj_darkhast_bagh_zamin= tk.Label(darkhast_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_metraj_darkhast_bagh_zamin.place(x=900 , y=20)

error_lable_gheimat_kol_darkhast_bagh_zamin= tk.Label(darkhast_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_gheimat_kol_darkhast_bagh_zamin.place(x=900 ,y=20)

error_lable_vadieh_darkhast_bagh_zamin= tk.Label(darkhast_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_vadieh_darkhast_bagh_zamin.place(x=900 ,y=20)

error_lable_darkhast_ejareh_mahaneh_bagh_zamin= tk.Label(darkhast_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_darkhast_ejareh_mahaneh_bagh_zamin.place(x=900 ,y=20)

error_lable_gheimat_metri_darkhast_bagh_zamin= tk.Label(darkhast_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_gheimat_metri_darkhast_bagh_zamin.place(x=900 ,y=20)

error_lable_darkhast_address_bagh_zamin= tk.Label(darkhast_bagh_zamin_window, text="",fg="red",bg="#052340",font=("Shabnam",11))
error_lable_darkhast_address_bagh_zamin.place(x=835 , y=20)
...
label_midde_left_darkhast_karghah=tk.Label(darkhast_karghah_window,text="👤اطلاعات مشتری",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_midde_left_darkhast_karghah.place(x=100,y=395)

label_down_darkhast_karghah=tk.Label(darkhast_karghah_window,text="⚒️امکانات",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
...
combo_darkhast_kargah.bind("<<ComboboxSelected>>",change_darkhast_kargah_type)
...
ejareh_mahaneh_darkhast_kargah_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
gheimat_kol_darkhast_kargah_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
mablagh_pish_darkhast_kargah_entry.bind("<KeyRelease>",add_number_toman,add="+")
...
delete_btn_darkhast_kargah=tk.Button(darkhast_karghah_window,text="❌حذف",command=delete_darkhast_kargah,bg="#8B0000",fg="#ffffff",height=1,width=10 )
delete_btn_darkhast_kargah.place_forget()
...
gozaresh_maskoni.configure(bg="#052340")
gozaresh_maskoni.withdraw()

frame_up_right_gozaresh_maskoni= tk.Frame(gozaresh_maskoni,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=500,height=210)
frame_up_right_gozaresh_maskoni.configure(bg="#052340")
frame_up_right_gozaresh_maskoni.place(x=50,y=80)

title_label_gozaresh_maskoni = tk.Label(gozaresh_maskoni,text="گزارش مسکونی",bg="#052340",fg="#FFFFFF",font=("Shabnam", 16))
title_label_gozaresh_maskoni.place(x=230, y=17)

label_up_right_gozaresh_maskoni=tk.Label(gozaresh_maskoni,text=" 📑اطلاعات گزارش ",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_up_right_gozaresh_maskoni.place(x=80,y=60)

noe_gozaresh_maskoni=tk.Label(gozaresh_maskoni,text=" نوع گزارش ",bg="#052340",fg="#ffffff",font=("Shabnam",12),width=10)
noe_gozaresh_maskoni.place(x=437, y=120)

error_label_maskoni=tk.Label(gozaresh_maskoni,text='',font=("Shabnam",10),fg="#E91414",bg="#FFFFFF")
error_label_maskoni.place(x=150,y=230,width=260,height=25)
...
gozaresh_file_combo_maskoni.place(x=150, y=122)

save_gozaresh_maskoni = tk.Button(gozaresh_maskoni, text="✅تایید", command=excel_gozaresh_maskoni, bg="#00BFFF", fg="#FFFFFF", width=10, height=1)
save_gozaresh_maskoni.place(x=95, y=320)

back_to_home_gozaresh_maskoni = tk.Button(gozaresh_maskoni, text="🔙بازگشت", command=back_home_gozaresh_maskoni, bg="#052340", fg="#FFFFFF", width=10, height=1)
...
gozaresh_edari_tejari.configure(bg="#052340")
gozaresh_edari_tejari.withdraw()

frame_up_right_gozaresh_edari_tejari= tk.Frame(gozaresh_edari_tejari,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=500,height=210)
frame_up_right_gozaresh_edari_tejari.configure(bg="#052340")
frame_up_right_gozaresh_edari_tejari.place(x=50,y=80)

title_lbl_gozaresh_edari_tejari = tk.Label(gozaresh_edari_tejari,text="گزارش اداری و تجاری",bg="#052340",fg="#FFFFFF",font=("Shabnam", 15))
title_lbl_gozaresh_edari_tejari.place(x=210, y=17)

label_up_right_gozaresh_edari_tejari=tk.Label(gozaresh_edari_tejari,text=" 📑اطلاعات گزارش ",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_up_right_gozaresh_edari_tejari.place(x=80,y=60)

noe_gozaresh_edari_tejari=tk.Label(gozaresh_edari_tejari,text=" نوع گزارش ",bg="#052340",fg="#ffffff",font=("Shabnam",12),width=10)
noe_gozaresh_edari_tejari.place(x=437, y=120)

error_label_edari_tejari=tk.Label(gozaresh_edari_tejari,text='',font=("Shabnam",10),fg="#E91414",bg="#FFFFFF")
error_label_edari_tejari.place(x=150,y=230,width=260,height=25)
...
gozaresh_file_combo_edari_tejari.place(x=150, y=122)

save_gozaresh_edari_tejari = tk.Button(gozaresh_edari_tejari,text="✅تایید", command=excel_gozaresh_edari_tejari, bg="#00BFFF", fg="#FFFFFF", width=10, height=1)
save_gozaresh_edari_tejari.place(x=95, y=320)

back_to_home_gozaresh_edari_tejari = tk.Button(gozaresh_edari_tejari, text="🔙بازگشت", command=back_home_gozaresh_edari_tejari, bg="#052340", fg="#FFFFFF", width=10, height=1)
...
gozaresh_bagh_zamin.configure(bg="#052340")
gozaresh_bagh_zamin.withdraw()

frame_up_right_gozaresh_bagh_zamin= tk.Frame(gozaresh_bagh_zamin,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=530,height=210)
frame_up_right_gozaresh_bagh_zamin.configure(bg="#052340")
frame_up_right_gozaresh_bagh_zamin.place(x=35,y=80)

title_lbl_gozaresh_bagh_zamin = tk.Label(gozaresh_bagh_zamin,text="گزارش باغ و زمین",bg="#052340",fg="#FFFFFF",font=("Shabnam", 15))
title_lbl_gozaresh_bagh_zamin.place(x=230, y=17)

label_up_right_gozaresh_bagh_zamin=tk.Label(gozaresh_bagh_zamin,text=" 📑اطلاعات گزارش ",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_up_right_gozaresh_bagh_zamin.place(x=80,y=60)

noe_gozaresh_bagh_zamin=tk.Label(gozaresh_bagh_zamin,text=" نوع گزارش ",bg="#052340",fg="#ffffff",font=("Shabnam",12),width=10)
noe_gozaresh_bagh_zamin.place(x=460, y=120)

error_label_bagh_zamin=tk.Label(gozaresh_bagh_zamin,text='',font=("Shabnam",10),fg="#E91414",bg="#FFFFFF")
error_label_bagh_zamin.place(x=70,y=230,width=390,height=25)
...
gozaresh_file_combo_bagh_zamin.place(x=70 ,y=122)

save_gozaresh_bagh_zamin = tk.Button(gozaresh_bagh_zamin, text="✅تایید", command=excel_gozaresh_bagh_zamin, bg="#00BFFF", fg="#FFFFFF", width=10, height=1)
save_gozaresh_bagh_zamin.place(x=95, y=320)

back_to_home_gozaresh_bagh_zamin = tk.Button(gozaresh_bagh_zamin, text="🔙بازگشت", command=back_home_gozaresh_bagh_zamin, bg="#052340", fg="#FFFFFF", width=10, height=1)
...
gozaresh_kargah.configure(bg="#052340")
gozaresh_kargah.withdraw()

frame_up_right_gozaresh_kargah= tk.Frame(gozaresh_kargah,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=500,height=210)
frame_up_right_gozaresh_kargah.configure(bg="#052340")
frame_up_right_gozaresh_kargah.place(x=50,y=80)

title_lbl_gozaresh_kargah = tk.Label(gozaresh_kargah,text="گزارش کارگاه",bg="#052340",fg="#FFFFFF",font=("Shabnam", 15))
title_lbl_gozaresh_kargah.place(x=250, y=17)

label_up_right_gozaresh_kargah=tk.Label(gozaresh_kargah,text=" 📑اطلاعات گزارش ",bg="#052340",fg="#00BFFF",font=("Shabnam", 11))
label_up_right_gozaresh_kargah.place(x=80,y=60)

noe_gozaresh_kargah=tk.Label(gozaresh_kargah,text=" نوع گزارش ",bg="#052340",fg="#ffffff",font=("Shabnam",12),width=10)
noe_gozaresh_kargah.place(x=437, y=120)

error_label_kargah=tk.Label(gozaresh_kargah,text='',font=("Shabnam",10),fg="#E91414",bg="#FFFFFF")
error_label_kargah.place(x=150,y=230,width=260,height=25)
...
gozaresh_file_combo_kargah.place(x=150, y=122)

save_gozaresh_edari_kargah = tk.Button(gozaresh_kargah, text="✅تایید", command=excel_gozaresh_kargah, bg="#00BFFF", fg="#FFFFFF", width=10, height=1)
save_gozaresh_edari_kargah.place(x=95, y=320)

back_to_home_gozaresh_kargah = tk.Button(gozaresh_kargah, text="🔙بازگشت", command=back_home_gozaresh_kargah, bg="#052340", fg="#FFFFFF", width=10, height=1)
...
name_shakhs_aval_gharardad.place(x=325,y=180)
...
name_shakhs_dovom_gharardad.place(x=325,y=250)
...
tozih_gharardad.place(x=325,y=328)

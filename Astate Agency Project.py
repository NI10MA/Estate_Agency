...
def sabt_darkhast_maskoni(event=None):
    ...
    try:
        ...
        if change_type=="درخواست خرید مسکونی":
            ...
            gheimat_kol_darkhast_maskoni_lable.place(x=700, y=20, anchor="e")
            gheimat_kol_darkhast_maskoni_entry.place(x=30, y=13, width=350, height=25)

        elif change_type=="درخواست اجاره مسکونی":
           
           mablagh_ejare_darkhast_maskoni_lable.place(x=700, y=65, anchor="e")
           mablagh_ejare_darkhast_maskoni_entry.place(x=30, y=55, width=350, height=25)
           gheimat_pish_darkhast_maskoni_lable.place(x=700, y=20, anchor="e")
           gheimat_pish_darkhast_maskoni_entry.place(x=30, y=13, width=350, height=25)
...
def sabt_darkhast_edari_tejari(event=None):
    ...
    try:
        ...
        if change_type=="درخواست خرید اداری/تجاری":
            ...
            gheimat_kol_darkhast_edari_tejari_lable.place(x=700, y=20, anchor="e")
            gheimat_kol_darkhast_edari_tejari_entry.place(x=30, y=13, width=350, height=25)

        elif change_type=="درخواست اجاره اداری/تجاری":
           gheimat_kol_darkhast_edari_tejari_entry.place_forget()
           mablagh_vadie_darkhast_edari_tejari_lable.place(x=700, y=20, anchor="e")
           mablagh_vadie_darkhast_edari_tejari_entry.place(x=30, y=13, width=350, height=25)
           mablagh_ejareh_darkhast_edari_tejari_lable.place(x=700, y=50 ,anchor="e")
           mablagh_ejareh_darkhast_edari_tejari_entry.place(x=30, y=40, width=350, height=25)
        ...
        if file == "فروش":
            ...
            if melk=="مسکونی":
                ...
                """, (f"%{address_entry.get().strip()}%",))
                    ...
                    cursor.execute("""
                    SELECT id,"sabt_ejareh_edari_tejari",address, gheimat_kol, type_melk, name_malek ,'اجاره' AS noe_file
            ...
            if melk=="maskoni":
                cursor.execute("""
                SELECT id,"darkhast_kharid_maskoni",address, gheimat_kol, type_melk, name_malk, 'درخواست خرید'AS noe_file
                FROM darkhast_kharid_maskoni
                WHERE address LIKE %s

                UNION ALL

                SELECT id,"darkhast_ejareh_maskoni",address, gheimat_kol, type_melk, name_malk,'درخواست اجاره' AS noe_file
                FROM darkhast_ejareh_maskoni
                WHERE address LIKE %s
                """,
                (
                    f"%{address_entry.get().strip()}%",
                ...
                cursor.execute("""
                SELECT id,"darkhast_kharid_edari_tejari",address, gheimat_kol, type_melk, name_malk,'درخواست خرید' AS noe_file
                FROM darkhast_kharid_edari_tejari
                WHERE address LIKE %s
                UNION ALL
                SELECT id,"darkhast_ejareh_edari_tejari",address, gheimat_kol, type_melk, name_malk, 'درخواست اجاره' AS noe_file
                FROM darkhast_ejareh_edari_tejari
                WHERE address LIKE %s
                """,
                (
                    f"%{address_entry.get().strip()}%",
...
ejareh_maskoni_window.geometry("1500x800")
ejareh_maskoni_window.configure(bg="#052340")
ejareh_maskoni_window.withdraw()

#------------------کادر اجاره مسکونی------------#

frame_up_right_ejareh_maskoni = tk.Frame(ejareh_maskoni_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_ejareh_maskoni.configure(bg="#052340")
frame_up_right_ejareh_maskoni.place(x=720,y=90)
...
frame_up_left_ejareh_maskoni.place(x=40,y=90)

frame_midde_right_ejareh_maskoni= tk.Frame(ejareh_maskoni_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_ejareh_maskoni.configure(bg="#052340")
frame_midde_right_ejareh_maskoni.place(x=720,y=410)
...
frame_midde_left_ejareh_maskoni.place(x=40,y=410)

frame_down_ejareh_maskoni= tk.Frame(ejareh_maskoni_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_ejareh_maskoni.configure(bg="#052340")
frame_down_ejareh_maskoni.place(x=40,y=580)
...
title_label_up1_ejareh_maskoni.place(x=650, y=17)   
...
title_label_up2_ejareh_maskoni.place(x=650, y=45)
...
melk_type_ejareh_maskoni_lable.place(x=700, y=40, anchor="e")
...
melk_type_ejareh_maskoni_entry.place(x=30, y=20, width=350, height=25)
...
sal_sakht_ejareh_maskoni_lable.place(x=700, y=80, anchor="e")

sal_sakht_ejareh_maskoni_entry = tk.Entry(frame_up_right_ejareh_maskoni, bg="#052340", fg="#ffffff", font=("Shabnam", 10))
sal_sakht_ejareh_maskoni_entry.place(x=30, y=70, width=350, height=25)
...
gheimat_pish_ejare_maskoni_lable.place(x=700, y=20, anchor="e")

gheimat_pish_ejare_maskoni_entry = tk.Entry(frame_midde_right_ejareh_maskoni, bg="#052340", fg="#ffffff", font=("Shabnam", 10))
gheimat_pish_ejare_maskoni_entry.place(x=30, y=13, width=350, height=25)
...
gheimat_ejare_ejare_maskoni_lable.place(x=700, y=65, anchor="e")

gheimat_ejare_ejare_maskoni_entry = tk.Entry(frame_midde_right_ejareh_maskoni, bg="#052340", fg="#ffffff", font=("Shabnam", 10))
gheimat_ejare_ejare_maskoni_entry.place(x=30, y=55, width=350, height=25)
...
addrres_ejareh_maskoni_lable.place(x=700, y=110, anchor="e")
...
ejareh_edari_tejari_window.geometry("1500x800")
ejareh_edari_tejari_window.withdraw()

#----------------------کادر اجاره اداری و تجاری------------------#

frame_up_right_ejareh_edari_tejari= tk.Frame(ejareh_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_ejareh_edari_tejari.configure(bg="#052340")
frame_up_right_ejareh_edari_tejari.place(x=720,y=90)
...
frame_up_left_ejareh_edari_tejari.place(x=40,y=90)

frame_midde_right_ejareh_edari_tejari= tk.Frame(ejareh_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_ejareh_edari_tejari.configure(bg="#052340")
frame_midde_right_ejareh_edari_tejari.place(x=720,y=410)
...
frame_midde_left_ejareh_edari_tejari.place(x=40,y=410)

frame_down_ejareh_edari_tejari= tk.Frame(ejareh_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_ejareh_edari_tejari.configure(bg="#052340")
frame_down_ejareh_edari_tejari.place(x=40,y=580)

title_label_up1 = tk.Label(ejareh_edari_tejari_window,text="فروش اداری و تجاری",bg="#052340",fg="#00BFFF",font=("Shabnam", 16))
title_label_up1.place(x=650, y=17)

title_label_up2 = tk.Label(ejareh_edari_tejari_window,text="ثبت اطلاعات فروش اداری و تجاری",bg="#052340",fg="#ffffff",font=("Shabnam", 11))
...
melk_type_ejareh_edari_tejari_lable.place(x=700,y=40, anchor="e")
...
melk_type_ejareh_edari_tejari_entry.place(x=30, y=30, width=350, height=25)
...
sal_sakht_ejareh_edari_tejari_lable.place(x=700, y=80, anchor="e")

sal_sakht_ejareh_edari_tejari_entry=tk.Entry(frame_up_right_ejareh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
sal_sakht_ejareh_edari_tejari_entry.place(x=30, y=70, width=350, height=25)
...
metraj_melk_ejareh_edari_tejari_lable.place(x=700, y=120, anchor="e")

metraj_melk_ejareh_edari_tejari_entry=tk.Entry(frame_up_right_ejareh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
metraj_melk_ejareh_edari_tejari_entry.place(x=30, y=110, width=350, height=25)
...
tabaghe_ejareh_edari_tejari_lable.place(x=700, y=160, anchor="e")

tabaghe_ejareh_edari_tejari_entry=tk.Entry(frame_up_right_ejareh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
tabaghe_ejareh_edari_tejari_entry.place(x=30, y=150, width=350, height=25)
...
vahed_ejareh_edari_tejari_lable.place(x=700, y=200, anchor="e")

vahed_ejareh_edari_tejari_entry=tk.Entry(frame_up_right_ejareh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
vahed_ejareh_edari_tejari_entry.place(x=30, y=190, width=350, height=25)
...
mablagh_pish_ejareh_edari_tejari_lable.place(x=700, y=240, anchor="e")

mablagh_pish_ejareh_edari_tejari_entry=tk.Entry(frame_up_right_ejareh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
mablagh_pish_ejareh_edari_tejari_entry.place(x=30, y=230, width=350, height=25)
...
mablagh_ejare_ejareh_edari_tejari_lable.place(x=700, y=30, anchor="e")
...
mablagh_ejare_ejareh_edari_tejari_entry.place(x=30, y=20, width=350, height=25)
...
addrres_ejareh_edari_tejari_lable.place(x=700, y=80, anchor="e")

addrres_ejareh_edari_tejari_entry=tk.Text(frame_midde_right_ejareh_edari_tejari, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
addrres_ejareh_edari_tejari_entry.place(x=30, y=70, width=350, height=50)
...
parking_ch_btn_ejareh_edari_tejari.place(x=1200, y=50)
...
parking_btn_ejareh_edari_tejari.place(x=1205,y=90)
...
asansor_ch_btn_ejareh_edari_tejari.place(x=1100, y=50)
...
asansor_btn_ejareh_edari_tejari.place(x=1105,y=90)
...
anbari_ch_btn_ejareh_edari_tejari.place(x=1000, y=50)
...
anbari_btn_ejareh_edari_tejari.place(x=1005,y=90)
...
ab_va_gaz_emkanat_ejareh_edari_tejari.place(x=840, y=20)
...
ab_va_gaz_combo_emkanat_ejareh_edari_tejari.place(x=640, y=20)
...
sarmayesh_emkanat_ejareh_edari_tejari.place(x=840, y=80)
...
sarmayesh_combo_emkanat_ejareh_edari_tejari.place(x=640, y=80)
...
garmayesh_emkanat_ejareh_edari_tejari.place(x=510, y=50)
...
garmayesh_combo_emkanat_ejareh_edari_tejari.place(x=340, y=50)
...
back_to_home_ejareh_edari_tejari.place(x=700,y=750)
...
zakhire_ejareh_edari_tejari.place(x=550,y=750)
...
ejareh_karghah_window.geometry("1500x800")
ejareh_karghah_window.configure(bg="#052340")
ejareh_karghah_window.withdraw()

frame_up_right_ejareh_karghah = tk.Frame(ejareh_karghah_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_ejareh_karghah.configure(bg="#052340")
frame_up_right_ejareh_karghah.place(x=720,y=90)
...
frame_up_left_ejareh_karghah.place(x=40,y=90)

frame_midde_right_ejareh_karghah= tk.Frame(ejareh_karghah_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_ejareh_karghah.configure(bg="#052340")
frame_midde_right_ejareh_karghah.place(x=720,y=410)
...
frame_midde_left_ejareh_karghah.place(x=40,y=410)

frame_down_ejareh_karghah= tk.Frame(ejareh_karghah_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_ejareh_karghah.configure(bg="#052340")
frame_down_ejareh_karghah.place(x=40,y=580)
...
title_label_up1_ejareh_karghah.place(x=650, y=17)   
...
title_label_up2_ejareh_karghah.place(x=650, y=45)
...
sal_sakht_ejareh_karghah_lable.place(x=520, y=80, anchor="e")

sal_sakht_ejareh_karghah_entry = tk.Entry(frame_up_right_ejareh_karghah, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
sal_sakht_ejareh_karghah_entry.place(x=30, y=70, width=354, height=25)
...
karbari_zamin_ejareh_karghah_lable.place(x=520, y=30, anchor="e")
...
karbari_zamin_ejareh_karghah_entry.place(x=30, y=20, width=350, height=25)
...
metraj_ejareh_karghah_lable.place(x=520, y=120,anchor="e")

metraj_ejareh_karghah_entry = tk.Entry(frame_up_right_ejareh_karghah, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
metraj_ejareh_karghah_entry.place(x=30, y=110, width=350, height=25)
...
time_ejate_ejareh_kargah_lable.place(x=520, y=160, anchor="e")
...
time_ejare_ejareh_kargah_combo.place(x=30, y=152, width=350, height=25)
...
vadie_ejare_karghah_lable.place(x=580, y=20, anchor="e")

vadie_ejare_karghah_entry = tk.Entry(frame_midde_right_ejareh_karghah, bg="#ffffff", fg="#ffffff", font=("Shabnam", 10))
vadie_ejare_karghah_entry.place(x=30, y=13, width=350, height=25)
...
gheimat_ejare_ejare_karghah_lable.place(x=580, y=65, anchor="e")

gheimat_ejare_ejare_karghah_entry = tk.Entry(frame_midde_right_ejareh_karghah, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
gheimat_ejare_ejare_karghah_entry.place(x=30, y=55, width=350, height=25)

addrres_ejareh_karghah_lable = tk.Label(frame_midde_right_ejareh_karghah, text="منطقه و آدرس", bg="#052340", fg="#ffffff", font=("Shabnam", 12), width=12)
addrres_ejareh_karghah_lable.place(x=580, y=110, anchor="e")
addrres_ejareh_karghah_entry = tk.Text(frame_midde_right_ejareh_karghah, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
addrres_ejareh_karghah_entry.place(x=30, y=90, width=350, height=50)
...
sarmaesh_ejareh_karghah.place(x=1150, y=50)
...
toilet_ejareh_karghah_combo.place(x=680, y=80)

vaziat_bagh_ejareh_karghah=tk.Label(frame_down_ejareh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=15,text="وضعیت برق")
vaziat_bagh_ejareh_karghah.place(x=850, y=50)
...
vaziat_bargh_ejareh_karghah_combo.place(x=680, y=50)
...
vaziat_ab_ejareh_karghah.place(x=370, y=50)

vaziat_ab_ejareh_karghah_combo=ttk.Combobox(frame_down_ejareh_karghah,width=18)
vaziat_ab_ejareh_karghah_combo["values"]=(""," آب  لوله کشی (بدون فشار) " ," آب لوله کشی (همراه موتور فشار) ","دارای منبع(همراه موتور فشار)","دارای منبع(بدون فشار)")
vaziat_ab_ejareh_karghah_combo.set("")
vaziat_ab_ejareh_karghah_combo["state"]=["readonly"]
vaziat_ab_ejareh_karghah_combo.place(x=230, y=50)

abzar_ejareh_karghah=tk.Label(frame_down_ejareh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=15,text=" ابزار صنعتی ")
abzar_ejareh_karghah.place(x=366, y=80)

abzaar_ejareh_karghah_combo=ttk.Combobox(frame_down_ejareh_karghah,width=23)
abzaar_ejareh_karghah_combo["values"]=("","(کارگاه خالی) بدون دستگاه ","دارای دستگاه")
abzaar_ejareh_karghah_combo.set("")
abzaar_ejareh_karghah_combo["state"]=["readonly"]
abzaar_ejareh_karghah_combo.place(x=200, y=80)

hamam_ejareh_karghah=tk.Label(frame_down_ejareh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=13,text="حمام")
hamam_ejareh_karghah.place(x=150, y=80)

hamam_ejareh_karghah__combo=ttk.Combobox(frame_down_ejareh_karghah)
hamam_ejareh_karghah__combo["values"]=("","ندارد","دارد")
hamam_ejareh_karghah__combo.set("")
hamam_ejareh_karghah__combo["state"]=["readonly"]
hamam_ejareh_karghah__combo.place(x=5, y=80)

otagh_ejareh_karghah=tk.Label(frame_down_ejareh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=17,text="اتاق رخت کن و استراحت")
otagh_ejareh_karghah.place(x=120, y=50)
...
otagh_ejareh_karghah_combo.place(x=5, y=50)
...
back_to_home_ejareh_karghah.place(x=700,y=750)
...
save_button_ejareh_mkarghah.place(x=550,y=750)

ejareh_karghah_window.protocol("WM_DELETE_WINDOW", lambda: None)
ejareh_karghah_window.resizable(False, False)#---------------------پنجره امکانات اجاره کارگاه---------------------
#endregion
...
forosh_edari_tejari_window.geometry("1500x800")
forosh_edari_tejari_window.withdraw()

#----------------------کادر فروش اداری و تجاری------------------#

frame_up_right_forosh_edari_tejari= tk.Frame(forosh_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_forosh_edari_tejari.configure(bg="#052340")
frame_up_right_forosh_edari_tejari.place(x=720,y=90)
...
frame_up_left_forosh_edari_tejari.place(x=40,y=90)

frame_midde_right_forosh_edari_tejari= tk.Frame(forosh_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_forosh_edari_tejari.configure(bg="#052340")
frame_midde_right_forosh_edari_tejari.place(x=720,y=410)
...
frame_midde_left_forosh_edari_tejari.place(x=40,y=410)

frame_down_forosh_edari_tejari= tk.Frame(forosh_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_forosh_edari_tejari.configure(bg="#052340")
frame_down_forosh_edari_tejari.place(x=40,y=580)
...
melk_type_forosh_edari_tejari_lable.place(x=700,y=40, anchor="e")
...
melk_type_forosh_edari_tejari_entry.place(x=30, y=30, width=350, height=25)
...
sal_sakht_forosh_edari_tejari.place(x=700, y=80, anchor="e")

sal_sakht_forosh_edari_tejari_entry=tk.Entry(frame_up_right_forosh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
sal_sakht_forosh_edari_tejari_entry.place(x=30, y=70, width=350, height=25)
...
metraj_forosh_edari_tejari.place(x=700, y=120, anchor="e")

metraj_forosh_edari_tejari_entry=tk.Entry(frame_up_right_forosh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
metraj_forosh_edari_tejari_entry.place(x=30, y=110, width=350, height=25)
...
tabaghe_forosh_edari_tejari.place(x=700, y=160, anchor="e")

tabaghe_forosh_edari_tejari_entry=tk.Entry(frame_up_right_forosh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
tabaghe_forosh_edari_tejari_entry.place(x=30, y=150, width=350, height=25)
...
vahed_forosh_edari_tejari.place(x=700, y=200, anchor="e")

vahed_forosh_edari_tejari_entry=tk.Entry(frame_up_right_forosh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
vahed_forosh_edari_tejari_entry.place(x=30, y=190, width=350, height=25)
...
otagh_forosh_edari_tejari.place(x=700, y=240, anchor="e")

otagh_forosh_edari_tejari_entry=tk.Entry(frame_up_right_forosh_edari_tejari, bg="#FFFFFF", fg="#000000", font=("Shabnam", 10))
otagh_forosh_edari_tejari_entry.place(x=30, y=230, width=350, height=25)
...
gheimat_kol_forosh_edari_tejari.place(x=700, y=30, anchor="e")

gheimat_kol_forosh_edari_tejari_entry=tk.Entry(frame_midde_right_forosh_edari_tejari, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
gheimat_kol_forosh_edari_tejari_entry.place(x=30, y=20, width=350, height=25)
...
addrres_forosh_edari_tejari.place(x=700, y=80, anchor="e")

addrres_forosh_edari_tejari_entry=tk.Text(frame_midde_right_forosh_edari_tejari, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
addrres_forosh_edari_tejari_entry.place(x=30, y=70, width=350, height=50)
...
parking_ch_btn_forosh_edari_tejari.place(x=1200, y=50)
...
parking_ch_btn_forosh_edari_tejari_label.place(x=1205,y=90)
...
asansor_ch_btn_forosh_edari_tejari.place(x=1100, y=50)
...
asansor_ch_btn_forosh_edari_tejari_label.place(x=1105,y=90)
...
anbari_checkbuton_forosh_edari_tejari.place(x=1000, y=50)
...
anbari_checkbuton_forosh_edari_tejari_label.place(x=1005,y=90)
...
aab_va_gaz_forosh_edari_tejari.place(x=840, y=20)
...
aab_va_gaz_combo_forosh_edari_tejari.place(x=640, y=20)
...
sarmaesh_forosh_edari_tejari.place(x=840, y=80)
...
sarmaesh_combo_forosh_edari_tejari.place(x=640, y=80)
...
garmaesh_forosh_edari_tejari.place(x=510, y=50)
...
garmaesh_combo_forosh_edari_tejari.place(x=340, y=50)
...
back_to_home_forosh_edari_tejari.place(x=700,y=750)
...
zakhire_forosh_edari_tejari.place(x=550,y=750)
...
frame_down_forosh_bagh= tk.Frame(forosh_bagh_zamin_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_forosh_bagh.configure(bg="#052340")
frame_down_forosh_bagh.place(x=40,y=580)

frame_down_forosh_zamin=tk.Frame(forosh_bagh_zamin_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
...
abyari_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
type_tree_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
label_natige_forosh_bagh_zamin=tk.Label(frame_down_forosh_bagh,text="",width=10)
...
otagh_check_btn_forosh_bagh_zamin_label=tk.Label(frame_down_forosh_bagh,text="ویلا", bg="#052340", fg="#ffffff", font=("Shabnam", 9), width=7)
...
type_vila_forosh_bagh_zamin.place(x=550, y=20)

type_vila_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
type_vila_forosh_bagh_zamin_combo.place(x=410, y=20)
...
toilet_forosh_bagh_zamin_lable.place(x=550, y=60)

toilet_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
toilet_forosh_bagh_zamin_combo.place(x=410, y=60)

hamam_forosh_bagh_zamin=tk.Label(frame_down_forosh_bagh,bg="#052340",fg="#ffffff",font=("Shabnam",9),width=13,text="حمام")
hamam_forosh_bagh_zamin.place(x=550, y=100)

hamam_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
hamam_forosh_bagh_zamin_combo.place(x=415, y=100)

sanad_forosh_bagh_zamin_lable=tk.Label(frame_down_forosh_bagh,bg="#052340",fg="#ffffff",font=("Shabnam",9),width=13,text="سند")
sanad_forosh_bagh_zamin_lable.place(x=330, y=60)

sanad_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
sanad_forosh_bagh_zamin_combo.place(x=210, y=60)

option_forosh_bagh_zamin=tk.Label(frame_down_forosh_bagh,bg="#052340",fg="#ffffff",font=("Shabnam",9),width=13,text="امکانات تفریحی")
option_forosh_bagh_zamin.place(x=340, y=20)

option_forosh_bagh_zamin_combo=ttk.Combobox(frame_down_forosh_bagh)
...
option_forosh_bagh_zamin_combo.place(x=210, y=20)
...
add_option_button_forosh_bagh_zamin.place(x=110, y=20)

lable_natige_add_forosh_bagh_zamin=tk.Label(frame_down_forosh_bagh,text="",width=10)
lable_natige_add_forosh_bagh_zamin.place(x=25, y=20)
...
metraj_vila_forosh_bagh_zamin.place(x=330, y=100)

metraj_vila_forosh_bagh_zamin_entry=tk.Entry(frame_down_forosh_bagh,width=10,bg="#00BFFF",fg="#000000",state="disabled")
metraj_vila_forosh_bagh_zamin_entry.place(x=270, y=100)
...
sal_sakht_vila_forosh_bagh_zamin_lable.place(x=110, y=60)

sal_sakht_vila_forosh_bagh_zamin_entry=tk.Entry(frame_down_forosh_bagh,width=10,bg="#00BFFF",fg="#000000",state="disabled")
sal_sakht_vila_forosh_bagh_zamin_entry.place(x=40, y=60)
...
mojavez_sakht_check_btn_forosh_bagh_zamin.place(x=40, y=100)
...
mohavate_sazi_check_btn_forosh_bagh_zamin.place(x=150, y=100)
...
back_to_home_forosh_bagh_zamin.place(x=700,y=750)
...
zakhire_forosh_bagh_zamin.place(x=550,y=750)
...
forosh_karghah_window.geometry("1500x800")
forosh_karghah_window.configure(bg="#052340")
forosh_karghah_window.withdraw()

frame_up_right_forosh_karghah = tk.Frame(forosh_karghah_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_forosh_karghah.configure(bg="#052340")
frame_up_right_forosh_karghah.place(x=720,y=90)
...
frame_midde_right_forosh_karghah= tk.Frame(forosh_karghah_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_forosh_karghah.configure(bg="#052340")
frame_midde_right_forosh_karghah.place(x=720,y=410)
...
frame_midde_left_forosh_karghah.place(x=40,y=410)

frame_down_forosh_karghah= tk.Frame(forosh_karghah_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_forosh_karghah.configure(bg="#052340")
frame_down_forosh_karghah.place(x=40,y=580)

title_label_up1_forosh_karghah= tk.Label(forosh_karghah_window,text="فروش کارگاه",bg="#052340",fg="#00BFFF",font=("Shabnam", 16))
title_label_up1_forosh_karghah.place(x=650, y=17)   
...
title_label_up2_forosh_karghah.place(x=650, y=45)
...
sal_sakht_forosh_kargah_lable.place(x=520, y=80, anchor="e")

sal_sakht_forosh_kargah_entry = tk.Entry(frame_up_right_forosh_karghah, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
sal_sakht_forosh_kargah_entry.place(x=30, y=70, width=354, height=25)
...
karbari_forosh_kargah.place(x=520, y=30, anchor="e")
...
#--------------------------فریم راست وسط---------------------
loctaion_forosh_kargah = tk.Label(frame_midde_right_forosh_karghah, text="منطقه و آدرس", bg="#052340", fg="#ffffff", font=("Shabnam", 12), width=12)
loctaion_forosh_kargah.place(x=580, y=65, anchor="e")

loctaion_forosh_kargah_entry = tk.Text(frame_midde_right_forosh_karghah, bg="#ffffff", fg="#000000", font=("Shabnam", 10))
loctaion_forosh_kargah_entry.place(x=30, y=55, width=350, height=80)
...
gheimat_kol_forosh_kargah_lable.place(x=580, y=20, anchor="e")

gheimat_kol_forosh_kargah_entry=tk.Entry(frame_midde_right_forosh_karghah,bg="#ffffff", fg="#000000",font=("Shabnam", 10))
gheimat_kol_forosh_kargah_entry.place(x=30, y=13, width=350, height=25)
...
sarmayesh_forosh_kargah.place(x=1150, y=50)
...
toilet_forosh_kargah_combo.place(x=680, y=80)

vaziat_bagh_forosh_kargah=tk.Label(frame_down_forosh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=15,text="وضعیت برق")
vaziat_bagh_forosh_kargah.place(x=850, y=50)
...
vaziat_bargh_forosh_kargah_combo.place(x=680, y=50)


vaziat_ab_forosh_kargah=tk.Label(frame_down_forosh_karghah,bg="#052340",fg="#ffffff",width=13,text=" وضعیت آب",font=("Shabnam", 9))
vaziat_ab_forosh_kargah.place(x=370, y=50)

vaziat_ab_forosh_kargah_combo=ttk.Combobox(frame_down_forosh_karghah,width=18)
...
vaziat_ab_forosh_kargah_combo.place(x=230, y=50)

abzar_forosh_kargah=tk.Label(frame_down_forosh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=15,text=" ابزار صنعتی ")
abzar_forosh_kargah.place(x=366, y=80)

abzar_forosh_kargah_combo=ttk.Combobox(frame_down_forosh_karghah,width=23)
abzar_forosh_kargah_combo["values"]=("","(کارگاه خالی) بدون دستگاه ","دارای دستگاه")
abzar_forosh_kargah_combo.set("")
abzar_forosh_kargah_combo["state"]=["readonly"]
abzar_forosh_kargah_combo.place(x=200, y=80)

hamam_forosh_kargah=tk.Label(frame_down_forosh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=13,text="حمام")
hamam_forosh_kargah.place(x=150, y=80)

hamam_forosh_kargah_combo=ttk.Combobox(frame_down_forosh_karghah)
hamam_forosh_kargah_combo["values"]=("","ندارد","دارد")
hamam_forosh_kargah_combo.set("")
hamam_forosh_kargah_combo["state"]=["readonly"]
hamam_forosh_kargah_combo.place(x=5, y=80)

otagh_forosh_kargah=tk.Label(frame_down_forosh_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=17,text="اتاق رخت کن و استراحت")
otagh_forosh_kargah.place(x=120, y=50)
...
otagh_forosh_kargah_combo.place(x=5, y=50)
...
back_to_home_forosh_kargah.place(x=700,y=750)
...
zakhire_forosh_kargah.place(x=550,y=750)
...
darkhast_maskoni_window.geometry("1500x800")
darkhast_maskoni_window.configure(bg="#052340")
darkhast_maskoni_window.withdraw()

frame_up_right_darkhast_maskoni = tk.Frame(darkhast_maskoni_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_darkhast_maskoni.configure(bg="#052340")
frame_up_right_darkhast_maskoni.place(x=720,y=90)
...
frame_up_left_darkhast_maskoni.place(x=40,y=90)

frame_midde_right_darkhast_maskoni= tk.Frame(darkhast_maskoni_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_darkhast_maskoni.configure(bg="#052340")
frame_midde_right_darkhast_maskoni.place(x=720,y=410)
...
frame_midde_left_darkhast_maskoni.place(x=40,y=410)

frame_down_darkhast_maskoni= tk.Frame(darkhast_maskoni_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_darkhast_maskoni.configure(bg="#052340")
frame_down_darkhast_maskoni.place(x=40,y=580)
...
title_label_up1_darkhast_maskoni.place(x=610, y=17)   
...
title_label_up2_darkhast_maskoni.place(x=618, y=45)
...
melk_type_darkhast_maskoni.place(x=700, y=40, anchor="e")
...
melk_type_darkhast_maskoni_entry.place(x=30, y=20, width=350, height=25)
...
sal_sakht_darkhast_maskoni.place(x=700, y=80, anchor="e")

sal_sakht_darkhast_maskoni_entry=tk.Entry(frame_up_right_darkhast_maskoni,bg="#ffffff", fg="#000000",font=("Shabnam", 10))
sal_sakht_darkhast_maskoni_entry.place(x=30, y=70, width=350, height=25)
...
addrres_darkhast_maskoni.place(x=700, y=110, anchor="e")

addrres_darkhast_maskoni_entry=tk.Entry(frame_midde_right_darkhast_maskoni,bg="#ffffff", fg="#000000",font=("Shabnam", 10),)
addrres_darkhast_maskoni_entry.place(x=30, y=90, width=350, height=50)
...
parking_ch_btn_darkhast_maskoni.place(x=1200, y=50)
...
parking_ch_btn_darkhast_maskoni_label.place(x=1205,y=90)
...
asansor_ch_btn_darkhast_maskoni.place(x=1100, y=50)
...
asansor_ch_btn_darkhast_maskoni_label.place(x=1105,y=90)
...
anbari_checkbuton_darkhast_maskoni.place(x=1000, y=50)
...
kaf_combo_darkhast_maskoni.place(x=300, y=50)
...
toilet_darkhast_maskoni.place(x=480, y=80)
...
toilet_combo_darkhast_maskoni.place(x=300, y=80)
...
back_to_home_darkhast_maskoni.place(x=700,y=750)
...
zakhire_darkhast_maskoni.place(x=550,y=750)
...
darkhast_edari_tejari_window.geometry("1500x800")
darkhast_edari_tejari_window.withdraw()

#----------------------کادر درخواست اداری و تجاری------------------#

frame_up_right_darkhast_edari_tejari= tk.Frame(darkhast_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=300)
frame_up_right_darkhast_edari_tejari.configure(bg="#052340")
frame_up_right_darkhast_edari_tejari.place(x=720,y=90)
...
frame_up_left_darkhast_edari_tejari.place(x=40,y=90)

frame_midde_right_darkhast_edari_tejari= tk.Frame(darkhast_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=730,height=150)
frame_midde_right_darkhast_edari_tejari.configure(bg="#052340")
frame_midde_right_darkhast_edari_tejari.place(x=720,y=410)
...
frame_midde_left_darkhast_edari_tejari.place(x=40,y=410)

frame_down_darkhast_edari_tejari= tk.Frame(darkhast_edari_tejari_window,bd=0,highlightthickness=1,highlightbackground="#00BFFF",width=1410,height=150)
frame_down_darkhast_edari_tejari.configure(bg="#052340")
frame_down_darkhast_edari_tejari.place(x=40,y=580)
...
melk_type_darkhast_edari_tejari_lable.place(x=700,y=40, anchor="e")
...
combo_darkhast_edari_tejari_entry.place(x=30, y=30, width=350, height=25)
...
sal_sakht_darkhast_edari_tejari_lable.place(x=700, y=80, anchor="e")

sal_sakht_darkhast_edari_tejari_entry=tk.Entry(frame_up_right_darkhast_edari_tejari,bg="#ffffff", fg="#000000",font=("Shabnam", 10))
sal_sakht_darkhast_edari_tejari_entry.place(x=30, y=70, width=350, height=25)
...
metraj_melk_darkhast_edari_tejari_lable.place(x=700, y=120, anchor="e")
...
metraj_melk_darkhast_edari_tejari_entry.place(x=30, y=110, width=350, height=25)
...
tabaghe_darkhast_edari_tejari_lable.place(x=700, y=160, anchor="e")

tabaghe_darkhast_edari_tejari_entry=tk.Entry(frame_up_right_darkhast_edari_tejari,bg="#ffffff", fg="#000000",font=("Shabnam", 10),)
tabaghe_darkhast_edari_tejari_entry.place(x=30, y=150, width=350, height=25)
...
vahed_darkhast_edari_tejari_lable.place(x=700, y=200, anchor="e")

vahed_darkhast_edari_tejari_entry=tk.Entry(frame_up_right_darkhast_edari_tejari,bg="#ffffff", fg="#000000",font=("Shabnam", 10),)
vahed_darkhast_edari_tejari_entry.place(x=30, y=190, width=350, height=25)
...
addrres_darkhast_edari_tejari_lable.place(x=700, y=110, anchor="e")

addrres_darkhast_edari_tejari_entry=tk.Entry(frame_midde_right_darkhast_edari_tejari,bg="#ffffff", fg="#000000",font=("Shabnam", 10),)
addrres_darkhast_edari_tejari_entry.place(x=30, y=90, width=350, height=50)
...
parking_check_btn_darkhast_edari_tejari.place(x=1200, y=50)
...
parking_ch_btn_darkhast_edari_tejari_label.place(x=1205,y=90)
...
asansor_check_btn_darkhast_edari_tejari.place(x=1100, y=50)
...
asansor_ch_btn_darkhast_edari_tejari_label.place(x=1105,y=90)
...
anbari_check_btn_darkhast_edari_tejari.place(x=1000, y=50)
...
anbari_checkbuton_darkhast_edari_tejari_label.place(x=1005,y=90)
...
aab_va_gaz_emkanat_darkhast_edari_tejari.place(x=840, y=20)
...
aab_va_gaz_combo_emkanat_darkhast_edari_tejari.place(x=640, y=20)
...
sarmayesh_emkanat_darkhast_edari_tejari.place(x=840, y=80)
...
sarmayesh_combo_emkanat_darkhast_edari_tejari.place(x=640, y=80)
...
garmayesh_emkanat_darkhast_edari_tejari.place(x=510, y=50)
...
garmayesh_combo_emkanat_darkhast_edari_tejari.place(x=340, y=50)

back_to_home_darkhast_edari_tejari=tk.Button(darkhast_edari_tejari_window,text="بازگشت",bg="#00BFFF", fg="#000000",width=10,height=2,command=back_home_darkhast_edari_tejari)
back_to_home_darkhast_edari_tejari.place(x=700,y=750)

zakhire_darkhast_edari_tejari=tk.Button(darkhast_edari_tejari_window,text="ذخیره",bg="#00BFFF", fg="#000000",width=10,height=2,command=sabt_darkhast_edari_tejari)
zakhire_darkhast_edari_tejari.place(x=550,y=750)
...
vaziat_bagh_darkhast_kargah=tk.Label(frame_down_darkhast_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=15,text="وضعیت برق")
...
sarmayesh_fan_darkhast_kargah=tk.Checkbutton(frame_down_darkhast_karghah,text="تهویه(فن)",variable=sarmayesh_fan_ejareh_kargah_var,background="#052340",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_fan_darkhast_kargah.place(x=570, y=50)

sarmayesh_panke_darkhast_kargah=tk.Checkbutton(frame_down_darkhast_karghah,text="پنکه سقفی",variable=sarmayesh_panke_ejareh_kargah_var,background="#052340",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_panke_darkhast_kargah.place(x=480, y=80)

sarmayesh_kooler_abi_darkhast_kargah=tk.Checkbutton(frame_down_darkhast_karghah,text="کولر آبی",variable=sarmayesh_kooler_abi_ejareh_kargah_var,background="#052340",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_abi_darkhast_kargah.place(x=570, y=80)

sarmayesh_kooler_gazi_darkhast_kargah=tk.Checkbutton(frame_down_darkhast_karghah,text="کولر گازی",variable=sarmayesh_kooler_gazi_ejareh_kargah_var,background="#052340",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_gazi_darkhast_kargah.place(x=480, y=50)
...
abzar_darkhast_kargah=tk.Label(frame_down_darkhast_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=15,text=" ابزار صنعتی ")
...
hamam_darkhast_kargah=tk.Label(frame_down_darkhast_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=13,text="حمام")
...
otagh_darkhast_kargah=tk.Label(frame_down_darkhast_karghah,bg="#052340",fg="#ffffff",font=("Shabnam", 9),width=17,text="اتاق رخت کن و استراحت")
